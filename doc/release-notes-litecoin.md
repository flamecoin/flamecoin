...
The minimum relay fee `-minrelayfee` has been lowered to 0.01 flames per kB (0.00001 FLA). This is to prepare for dropping the minimum transaction fee to 0.1 flames per kB (0.0001 FLA) in the next release.
