...
Output from `gbuild` will look something like
    ...
    From https://github.com/flamecoin/flamecoin
...
[flamecoin/gitian.sigs.ltc](https://github.com/flamecoin/gitian.sigs.ltc/) repository, or if that's not possible create a pull
