...
%{_sbindir}/semanage port -a -t bitcoin_port_t -p tcp 9192
%{_sbindir}/semanage port -a -t bitcoin_port_t -p tcp 19191
%{_sbindir}/semanage port -a -t bitcoin_port_t -p tcp 19192
...
if [ $1 -eq 0 ]; then
	...
	%{_sbindir}/semanage port -d -p tcp 9192
	%{_sbindir}/semanage port -d -p tcp 19191
	%{_sbindir}/semanage port -d -p tcp 19192
	for selinuxvariant in %{selinux_variants}; do
